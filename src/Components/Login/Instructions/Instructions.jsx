    ...
    return (
        <div className="formup-container sign-up-container">
            ...
            <form>
               ...
               <label className="instructions">1. Use Your GenePowerX email (ends with @genepowerx.com or khdreamlife.com)
               </label>
               <label className="instructions"> &nbsp; 2. Accept the Google Authentication</label>
               <h1 className="create">Example</h1>
               <input type="text" placeholder="yourname@genepowerx.com" disabled />
