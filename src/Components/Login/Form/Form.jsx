...
const Form = () => {
    ...
    return (
        <div className="form_page">
            ...
            <div className="Form">
                <h1 className="form_trans">Transforming healthcare through

                    <span className="toggle active">analysis</span>
                    <span className="toggle">innovation</span>
                    <span className="toggle">dedication</span>
                </h1>
